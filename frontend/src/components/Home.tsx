...
const Home: React.FC = () => {
  return (
    <div className="min-h-screen pt-6 dark:bg-slate-950 overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col text-center justify-center mb-8">
              <div className="align-center justify-center mb-4 p-2">
                <img src={logo} width={280} height={280} alt="logo" className=""/>
              </div>
            <div className="justify-center items-center">
            <h1 className="font-bold m-8 items-center leading-tight">
              <span className="justify-items-center text-2xl md:text-5xl text-slate-900 dark:text-white">AI-Powered</span>
              <br />
            ...
            {[
              ...
              <div 
                ...
                className={`relative p-8 rounded-3xl shadow-xl border transition-all duration-300 hover:scale-105 ${
                  plan.highlighted 
                    ? 'bg-gradient-to-b dark:hover:backdrop-blue-md hover:bg-accent-400/25 hover:border-white/75 text-white border-primary-500 scale-105' 
                    : 'bg-white/80 dark:bg-slate-700/50 backdrop-blur-sm border-white/20 hover:scale-105 text-slate-900 dark:text-white'
                }`}
              >
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r  from-accent-400 to-secondary-400 text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Most Popular
                    </div>
                  </div>
                )}
                ...
                <Link
                  ...
                  className={`block w-full py-4 text-center font-semibold rounded-2xl transition-all duration-200 ${
                    plan.highlighted
                      ? 'bg-white dark:bg-accent-200/80 dark:text-slate-800/90 text-blue-600 hover:bg-blue-50'
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl text-black dark:text-white font-bold">AssisText</span>
              </div>
