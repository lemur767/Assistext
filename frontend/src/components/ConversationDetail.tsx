...
import "../styles/ConversationDetail_dashboard.css";
...
const ConversationDetail: React.FC = () => {
  ...
  return (
    <div className="conversation-detail-container">
      <div className="conversation-detail-bg-image"></div>
      <div className="conversation-detail-content-wrapper">
        <div className="conversation-detail-card">
          <header className="conversation-detail-header">
            <div className="conversation-header-info">
              ...
              <div className="conversation-contact-details">
                ...
                <p className="conversation-status-text">{status}</p>
              </div>
            </div>
          ...
          <div className="conversation-messages-area custom-scrollbar">
            {messages.map((msg) => (
              <div
                key={msg.id}
                className={`message-row ${msg.direction}`}
              >
                <div
                  className={`message-bubble ${msg.direction === "inbound" ? "inbound" : msg.ai_generated ? "ai" : "user"}`}
                >
                  ...
                  {msg.ai_generated && (
                    <div className="ai-reply-indicator">
          ...
          <footer className="conversation-detail-footer">
